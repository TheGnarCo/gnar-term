...
### Included extensions (v1)

| Extension    | Type                    | Description                                                 |
| ------------ | ----------------------- | ----------------------------------------------------------- |
| Preview      | Surface type            | File preview (Markdown, etc.) — extracted from current core |
| File Browser | Secondary sidebar tab   | File tree — extracted from `jrvs/orchestrator` branch       |
| Profile Card | Primary sidebar section | Editable user profile card                                  |
