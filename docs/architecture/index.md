...
| [ADR-004: Workspace Groups Unification](../adr/004-workspace-groups-unification.md) | One grouping primitive replaces Projects + Orchestrators |
...
| [ADR-004](../adr/004-workspace-groups-unification.md) | Workspace Groups Unification | Accepted | Collapses Projects + Orchestrators into one Workspace Group primitive |
