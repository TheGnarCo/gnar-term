...
| Term                    | Definition                                                                                                                                                                                                                                                                                                                      |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Claimed Workspace**   | A workspace that an extension has marked as "owned" via `api.claimWorkspace()`. Claimed workspaces are hidden from the main Workspaces list and displayed in the extension's own sidebar section instead (e.g., project-scope claims workspaces belonging to a project).                                                        |
...
| **Project**             | A user-created grouping of workspaces. Projects appear as primary sidebar sections with their own color, claimed workspaces, and creation actions. Managed by the project-scope extension.                                                                                                                                      |
