...
describe("archiveWorkspace", () => {
  ...
  it("closes nestedWorkspaces, removes workspace, removes root row, and adds to archive", async () => {
    const workspace = makeWorkspace();
...
describe("unarchiveWorkspace", () => {
  ...
  it("restores the workspace, appends root row, creates nestedWorkspaces, and provisions dashboards", async () => {
    const workspace = makeWorkspace();
