 ...
 * in a repo path and merges its contents into the default WorkspaceTemplate.
 */
...
import type { WorkspaceTemplate } from "../lib/config";
...
describe("applyRepoDef", () => {
  it("merges repo def fields into the default def when bootstrap file exists", async () => {
    const repoDef: Partial<WorkspaceTemplate> = {
