...
describe("Agentic Orchestrator manifest", () => {
  ...
  it("declares the new-dashboard workspace action", () => {
    const actions = agenticOrchestratorManifest.contributes?.workspaceActions;
  ...
  it("declares the global 'agents' secondary sidebar tab (P11)", () => {
