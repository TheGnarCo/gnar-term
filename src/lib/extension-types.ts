...
// Re-export only the types actually imported through this module.
// Canonical definitions live in src/extensions/api.ts — add re-exports
// here only when core code (src/lib/ or tests) needs them.
export type {
  AppEvent,
  AppEventType,
...
/** Context key for extension API — matches the value in extensions/api.ts */
