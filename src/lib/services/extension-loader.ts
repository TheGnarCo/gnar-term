 ...
 * `ExtensionWrapper` (e.g. Workspaces — CRUD lives in core, but row
 * renderers still flow through the ExtensionWrapper path to inherit
 * the shared Svelte context).
 *
 ...
 * Call this on app close so state like workspace branchedWorkspaceIds doesn't
